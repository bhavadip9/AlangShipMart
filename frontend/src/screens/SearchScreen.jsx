...
//         }
//         fetchData();
//     }, [category, error, rating, page, price, query, order])
...
import { Helmet } from 'react-helmet-async';
import { Button, Col, Row } from 'react-bootstrap';
import Rating from '../Componet/Rating.jsx';
import LoadingBox from '../Componet/LoadingBox';
import MessageBox from '../Componet/MessageBox';
import Product from '../Componet/Product';
import LinkContainer from 'react-router-bootstrap/LinkContainer';
...
const SearchScreen = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [category, rating, page, price, query, order]);
    ...
    useEffect(() => {
        ...
        fetchCategories();
    }, []); // Removed categories from dependency array
